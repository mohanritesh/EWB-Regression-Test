...
@FindBy(xpath="(//a[contains(@href, '')])[121]")
...
///////////////////////////////////////////////////////////
	...
	@FindBy(xpath="//input[@name='365']")
	WebElement enableCheckboxForDeleteUser;
	
	//////////////////////
	@FindBy(id="ddlIsSEZUnitList")
	WebElement selectSEZUnitForAddGstin;
...
//Data Exist : duplicate entry being allowed for same BU name
	...
	public void addNewGstn(String companyName, String stateNew, String gstinNew, String userName, String passwordNew, String authorisedSignatoryName, 
		...
		//Gst Mstr_9: all special characters in the text field
				...
				Thread.sleep(3000);
				enterAuthorisedSignatoryNameForAddGstin.clear();
				Thread.sleep(3000);
	...
	public void addNewRole(String userLoginId, String companyName, String stateNew, String gstinNew,String businessUnit, String subBusinessUnitName, 
		...
		selectDropdown15.selectByVisibleText("Aashish");
		Thread.sleep(4000);
		...
		Thread.sleep(4000);
		//Search saved data
		searchData.sendKeys("Aashish\n");
		Thread.sleep(4000);
		driver.navigate().refresh();
		Thread.sleep(4000);
		//Asn Mstr_4: Try to update field
		//try to edit and update
		selectCheckboxForUpdateUserRole.click();
						Thread.sleep(4000);
	...
	public void addCustomerMaster(String companyName,String customerCode,String natureOfCustomer,String gstinNew,String customerName,String taxpayerCategory,
			String phoneNumber,String emailId,String addressNew1,String addressNew2,String placeNew,String pinCod,String stateNew) throws Exception {
		addNewButton.click();
		Thread.sleep(4000);
		saveButton.click();
	}
